...
@Component({
    ...
    <div class="login-page">
      <div class="login-card">
        ...
        <p class="app-description">
          Sign in to manage your tasks, track progress and stay on top of your work.
        </p>
  ...
  styles: [`
    ...
    .login-page {
      ...
      min-height: 100vh;
      background: linear-gradient(135deg, #1b2a1b 0%, #1b4d1b 50%, #2e7d32 100%);
      position: relative;
    }
    .login-page::before {
      content: '';
      position: absolute;
      inset: 0;
      background: radial-gradient(ellipse at 30% 70%, rgba(76, 175, 80, 0.15) 0%, transparent 60%);
      pointer-events: none;
    }
    .login-card {
      background: #ffffff;
