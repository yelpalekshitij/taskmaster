...
class SecurityConfig {
    ...
    // Caches one AuthenticationManager per distinct issuer value seen in JWTs.
    // Allows localhost:8180 tokens (browser-issued) and keycloak:8180 tokens to both validate,
    // while always fetching JWKS from the Docker-internal hostname.
